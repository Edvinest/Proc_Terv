...
namespace eval ::optrace {
  variable script "/home/edvinest/University/Architektura/proc_terv/proc_terv.runs/impl_1/Top_Level.tcl"
...
OPTRACE "create in-memory project" START { }
  ...
  set_property board_part_repo_paths {/home/edvinest/.Xilinx/Vivado/2023.2.2/xhub/board_store/xilinx_board_store} [current_project]
  set_property board_part tul.com.tw:pynq-z2:part0:1.0 [current_project]
  set_property design_mode GateLvl [current_fileset]
  set_param project.singleFileAddWarning.threshold 0
OPTRACE "create in-memory project" END { }
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir /home/edvinest/University/Architektura/proc_terv/proc_terv.cache/wt [current_project]
  set_property parent.project_path /home/edvinest/University/Architektura/proc_terv/proc_terv.xpr [current_project]
  set_property ip_output_repo /home/edvinest/University/Architektura/proc_terv/proc_terv.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet /home/edvinest/University/Architektura/proc_terv/proc_terv.runs/synth_1/Top_Level.dcp
